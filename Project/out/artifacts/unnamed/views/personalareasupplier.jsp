...
<t:wrapper>
    ...
    <form action="/personalarea" method="post">
        ...
        <div class="form-group row">
            <label for="apikey" class="col-sm-2 col-form-label">API-ключ</label>
            <label id="apikey" class="col-sm-2 col-form-label">${apikey}</label>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="nameCompany" name="nameCompany" class="form-control" id="nameCompany" value="${nameCompany}">
            </div>
        </div>
        <div class="form-group row">
